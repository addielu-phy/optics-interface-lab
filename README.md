...
- 獨立的筆電／平板版最上方重現六介質、五界面的全反射判斷題（不顯示教材編號），答案預設收合；互動預設與題目折射率一致，並以同折射率的第七層作為延伸層。
- 筆電／平板版固定保留控制台與光路圖左右並列，可直接按住入射光線或光源拖曳角度；界面 A 入射點與七層介質比例保持固定，每段光路都有固定尺寸的方向箭頭；介質以折射率連續色階呈現，數值越大顏色越深。
